...
import { toDollarString, toDateTimeInput } from '@/lib/utils';
import { Modal } from '@/components/ui';
import { Loader2 } from 'lucide-react';

interface EditPromotionFormProps {
  promotion: Promotion;
  onSubmit: (data: Partial<CreatePromotionDto>) => Promise<void>;
  onCancel: () => void;
}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-xs text-blue-900">
              <strong>Current Usage:</strong> {promotion.currentUses || 0} redemption{(promotion.currentUses || 0) !== 1 ? 's' : ''} across all promo codes
            </p>
          </div>
