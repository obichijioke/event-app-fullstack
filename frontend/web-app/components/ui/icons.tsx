...
export function CurrencyIcon({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
  );
}
...
export function TrendingUpIcon({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M7 14l5-5 5 5m0 0-5-5-5" />
      <path d="M12 21l-3-3m0-6l3-3" />
    </svg>
  );
}
