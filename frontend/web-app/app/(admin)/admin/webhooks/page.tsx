    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Monitor webhook activity</p>
        </div>
        <Link
          href="/admin"
      ...
      <div className="bg-card rounded-lg shadow-card p-6">
        <p className="text-muted-foreground">Content for Webhook Monitoring will be implemented here.</p>
        {/* TODO: Implement Webhook Monitoring functionality */}
      </div>
    </div>
  );
}
